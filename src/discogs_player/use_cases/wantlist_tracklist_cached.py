"""Read cached Discogs wantlist tracklist rows for UI rendering."""

from __future__ import annotations

from discogs_player.data.db import get_connection
from discogs_player.data.repo import get_wantlist_tracklist


def run_wantlist_tracklist_cached(release_id: int) -> dict[str, object]:
