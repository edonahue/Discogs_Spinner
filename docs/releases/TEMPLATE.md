...
- Windows installer (guided): [Spinner for Discogs_X.Y.Z_x64-setup.exe](https://github.com/edonahue/Discogs_Spinner/releases/download/vX.Y.Z/Spinner-for-Discogs_X.Y.Z_x64-setup.exe)
- Windows installer (MSI): [Spinner for Discogs_X.Y.Z_x64_en-US.msi](https://github.com/edonahue/Discogs_Spinner/releases/download/vX.Y.Z/Spinner-for-Discogs_X.Y.Z_x64_en-US.msi)
...
- Linux portable installer: [Spinner for Discogs_X.Y.Z_amd64.AppImage](https://github.com/edonahue/Discogs_Spinner/releases/download/vX.Y.Z/Spinner-for-Discogs_X.Y.Z_amd64.AppImage)
- macOS installer (Apple Silicon): [Spinner for Discogs_X.Y.Z_aarch64.dmg](https://github.com/edonahue/Discogs_Spinner/releases/download/vX.Y.Z/Spinner-for-Discogs_X.Y.Z_aarch64.dmg)
- macOS installer (Intel): [Spinner for Discogs_X.Y.Z_x64.dmg](https://github.com/edonahue/Discogs_Spinner/releases/download/vX.Y.Z/Spinner-for-Discogs_X.Y.Z_x64.dmg)
